...
const ProductCard = ({ product, handleAddCart }) => {
  const { category, name, price, stock, img } = product;
  console.log(product);
  ...
  return (
    <div>
      <div className="group mx-auto  max-w-[350px] space-y-6 rounded-xl bg-white  px-4 pb-8 pt-4 font-sans shadow-inner shadow-slate-400 hover:shadow-2xl dark:bg-[#18181B]">
        <div className="group-hover:scale-110 transition relative flex h-48 w-full justify-center lg:h-[230px]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-sm md:text-base">
          <button
            onClick={handleClick}
            className="flex items-center rounded-lg bg-[#49B2FF] px-4 py-2 font-sans font-semibold text-white duration-300 hover:scale-105 hover:bg-sky-600"
          >
            <svg
              width={35}
              viewBox="0 0 24 24"
            ...
            <span className="text-[#f5f5f3]">Add to Cart</span>
          </button>
        </div>
      </div>
    </div>
